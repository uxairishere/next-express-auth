    ...
    return (
        <div>
            <div className='text-white px-10 py-24' style={{ backgroundImage: `url(${headerbg.src})`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
                <h1 className='text-3xl uppercase font-bold'>User dashboard</h1>
                <h1>All the user controls and analytics will come here</h1>
            ...
            <div className='grid justify-center items-start grid-cols-3 gap-5 p-10'>
                {/* analytics  */}
                <div className='col-span-1 rounded-lg border border-gray-200 p-5 h-full'>
                    <h1 className='font-bold text-md mb-3'>Your templates</h1>
                </div>
                {/* settings  */}
                ...
                {/* user management  */}
                <div className='col-span-1 rounded-lg border border-gray-200 p-5 h-full'>
                    <h1 className='font-bold text-md mb-3'>Notifications</h1>
